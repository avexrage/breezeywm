...
@section('title', 'Cetak Pendaftaran Grha Wredha Mulya')
...
<ol class="breadcrumb float-sm-left">
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('datapdftrgrha') }}" class="text-decoration-none active">Data Pendaftaran</a>
    </li>
    <li class="breadcrumb-item">
        Cetak Grha Wredha Mulya
    </li>
</ol>
@endsection
...
<div class="card mb-4 shadow" style="border:none">
    <div class="card-body">
        <form method="GET" action="{{ route('cetakpdftrgrha') }}">
            <div class="row mb-3">
                <div class="col-lg-2">
